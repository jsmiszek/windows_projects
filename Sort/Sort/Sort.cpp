...
// Sort.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CSortApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CSortApp::OnAppAbout)
...
CSortApp::CSortApp()
{
	...
	SetAppID(_T("Sort.AppID.NoVersion"));
